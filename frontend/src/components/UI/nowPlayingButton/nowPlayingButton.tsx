...
import styles from './nowPlayingButton.module.css'

export const NowPlayingButton: React.FC = () => {
  ...
  return (
    <button onClick={toggleNowPlayingSidebar} style={{background: 'transparent', border: 'none', cursor: 'pointer'}}>
      <span aria-hidden="true">
        <svg
          ...
          aria-hidden="true"
          viewBox="0 0 16 16"
          className={styles.nowPlayingSVG}
        >
