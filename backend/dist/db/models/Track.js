...
const TrackSchema = new mongoose_1.Schema({
    ...
    album: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Album', required: false }, // if a track document doesnt have this album key, its a single (still uses album page UI, just slighly different)
